...
mymodels or training checkpoints against ImageNet or similarly organized image datasets. It prioritizes
...
def main():
    ...
    if os.path.isdir(args.checkpoint):
        ...
        if args.model == 'all':
            # validate all mymodels in a list of names with pretrained checkpoints
    ...
    if len(model_cfgs):
        ...
        _logger.info('Running bulk validation on these pretrained mymodels: {}'.format(', '.join(model_names)))
        results = []
        try:
