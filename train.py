...
# Batch norm parameters (only works with gen_efficientnet based mymodels currently)
group = parser.add_argument_group('Batch norm parameters', 'Only works with gen_efficientnet based mymodels currently.')
...
def main():
    ...
    if args.distributed and args.sync_bn:
        ...
        if has_apex and use_amp == 'apex':
            ...
            # WARNING this won't currently work with mymodels using BatchNormAct2d
